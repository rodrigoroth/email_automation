...
def handler(event, context):
    ...
    smtp.login('rodrigo.rothv@gmail.com', 'lmnsnhvzwselncge')

    subject = "Teste email automático"
    body = "Testando corpo email"

    # Call the message function
    msg = message(subject, body)

    # Make a list of emails, where you wanna send mail
    to = ["rodrigo.rothv@gmail.com", "rodrigo1992ster@gmail.com"]

    # Provide some data to the sendmail function!
    smtp.sendmail(from_addr="rodrigo.rothv@gmail.com",
...
def message(subject="email subject",
            text="email body text", img=None,
            attachment=None):
